...
import com.docscanner.app.presentation.editor.EditorViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.folders.FolderDetailViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.folders.FolderDetailViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.folders.FoldersViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.folders.FoldersViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.docscanner.app.presentation.home.HomeViewModel;
import com.docscanner.app.presentation.home.HomeViewModel_HiltModules;
import com.docscanner.app.presentation.home.HomeViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.home.HomeViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.scanner.ScannerViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.scanner.ScannerViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.search.SearchViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.search.SearchViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.trash.TrashViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import com.docscanner.app.presentation.viewer.ViewerViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.docscanner.app.presentation.viewer.ViewerViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerDocScannerApp_HiltComponents_SingletonC {
  private DaggerDocScannerApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public DocScannerApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements DocScannerApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public DocScannerApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements DocScannerApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements DocScannerApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements DocScannerApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements DocScannerApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements DocScannerApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements DocScannerApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public DocScannerApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends DocScannerApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends DocScannerApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends DocScannerApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends DocScannerApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends DocScannerApp_HiltComponents.ViewModelC {
    ...
    Provider<FoldersViewModel> foldersViewModelProvider;
  ...
  private static final class ActivityRetainedCImpl extends DocScannerApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends DocScannerApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends DocScannerApp_HiltComponents.SingletonC {
    ...
    PageDao pageDao() {
      return DatabaseModule_ProvidePageDaoFactory.providePageDao(provideAppDatabaseProvider.get());
    }

    FolderDao folderDao() {
      return DatabaseModule_ProvideFolderDaoFactory.provideFolderDao(provideAppDatabaseProvider.get());
    }
    ...
    @Override
    public void injectDocScannerApp(DocScannerApp docScannerApp) {
      injectDocScannerApp2(docScannerApp);
    }
